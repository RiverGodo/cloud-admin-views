        ...
        <el-form :model="formData">
          ...
          <el-form-item label="轮播图书籍">
            ...
            <el-form-item label="轮播图头图">
                <upload-img v-model="formData.img" style="float:left"></upload-img>
            </el-form-item>
        ...
        <el-table :data="bookData">
            ...
            <el-table-column  label="书籍头图" width="120">
                <template slot-scope="scop">
                    <img :src="scop.row.img" class="img-item">
                </template>
            </el-table-column>
            <el-table-column property="author" label="作者"></el-table-column>
            <el-table-column  label="操作">
                <template slot-scope="scop">
                   <el-button type="primary" size="small" @click="handleAddBook(scop.row._id)">
                       添加
                   </el-button>
                </template>
            </el-table-column>
